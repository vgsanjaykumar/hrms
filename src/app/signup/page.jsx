    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-white">
            <div className="w-96 shadow-lg p-10 rounded-xl text-center">
                <h1 className="text-2xl font-bold text-[#34b6b8] mb-4">Create your Diprella account</h1>
                ...
                <form onSubmit={handleSignup} className="space-y-4 text-left">
                    <input type="email" placeholder="Email" className="w-full px-4 py-2 bg-gray-100 rounded focus:outline-none focus:ring-2 focus:ring-[#34b6b8]" value={email} onChange={(e) => setEmail(e.target.value)}/>
                    <input type="password" placeholder="Password" className="w-full px-4 py-2 bg-gray-100 rounded focus:outline-none focus:ring-2 focus:ring-[#34b6b8]"  value={password} onChange={(e) => setPassword(e.target.value)}/>
