        ...
        <div className="min-h-screen flex flex-col md:flex-row bg-gray-100">
            ...
            <aside className={` bg-purple-600 text-white w-full md:w-64 p-6 space-y-6 ${showSidebar ? 'block' : 'hidden'} md:block`}>
                ...
                <nav className="flex flex-col gap-4">
                    ...
                    <a href="#My Profile" className="hover:bg-white hover:text-purple-600 p-2 rounded transition">My Profile</a>
                </nav>
                <div className="pt-6">
...
<UserCircleIcon className="w-10 h-10 text-purple-600" />                        <div className="text-sm">
